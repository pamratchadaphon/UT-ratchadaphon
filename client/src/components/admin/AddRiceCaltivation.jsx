...
const AddriceCaltivation = () => {
  ...
  return (
    <div>
      <button
        className="block text-white bg-green-600 hover:bg-green-100 hover:text-green-700 hover:border-green-700 duration-200 font-medium rounded-lg text-sm px-3 py-2.5 text-cente lg:mx-0 w-full"
        onClick={handleModal}
      >
        เพิ่มรอบการปลูก
      </button>
...
export default AddriceCaltivation;
