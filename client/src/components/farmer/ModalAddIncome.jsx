...
const ModalAddIncome = () => {
  ...
  return (
    <div>
      ...
      {isOpenModal ? (
        <div>
          <div className="overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 max-h-full bg-slate-400 bg-opacity-60 flex h-screen">
            <div className="relative p-4 w-full max-w-md max-h-full">
              <div className="relative bg-white rounded-lg shadow">
                ...
                <div className="p-4 md:p-5">
                  <form className="space-y-4 flex flex-col justify-start" onSubmit={handleSubmit}>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => setValues({...values, rice_price_per_kg: e.target.value})}
                        className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2.5"
                        required
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        name="price"
                        id="price"
                        value={Number(values.rice_price_per_kg) * Number(values.yield)}
                        disabled
