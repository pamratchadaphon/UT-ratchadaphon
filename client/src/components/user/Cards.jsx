        ...
        >
          ...
          <div className="p-2 sm:p-5">
            ...
            <div className="flex flex-wrap text-xs lg:text-sm gap-1 my-2">
              <div className="py-1 px-2 rounded-full text-violet-600 bg-violet-50">{d.type}</div>
              <div className="py-1 px-2 bg-orange-50 rounded-full text-orange-600">{d.photosensitivity}</div>
            </div>
